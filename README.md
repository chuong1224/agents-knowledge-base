...
- Pick an attachment from the Reader, vault tree, graph, quick switcher, or right search → one shared menu: **Open file** in the OS default app, **Show in folder**, or **View/download in the KB**. Native actions are same-origin POSTs constrained to real non-hidden files inside the vault
